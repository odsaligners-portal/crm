...
export default function Step2Page() {
  ...
  const handleNext = async (e) => {
    ...
    try {
      ...
      router.push(
        `/admin/patients/create-patient-record/step-3?id=${patientId}`,
      );
    } catch (error) {
      // fetchWithError handles toast
    } finally {
  ...
  const handleBack = () => {
    router.push(`/admin/patients/create-patient-record?id=${patientId}`);
  };
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-1">
              <div>
                ...
                <ReactSelect
                  ...
                  onChange={(option) =>
                    handleChange({
                      target: { name: "caseCategory", value: option.value },
                    })
                  }
