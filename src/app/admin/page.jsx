        ...
        <div className="relative">
          ...
          <div className="relative rounded-3xl border border-white/20 bg-white/70 p-8 shadow-2xl shadow-blue-500/10 backdrop-blur-xl dark:border-gray-700/30 dark:bg-gray-800/70">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-4xl font-semibold text-transparent subpixel-antialiased dark:from-white dark:via-blue-200 dark:to-purple-200">
                  Admin Dashboard
                </h1>
