...
export default function ProfileEditForm({ initialValues = {}, onSuccess }) {
  ...
  const [formData, setFormData] = useState({
    ...
    country: initialValues.country ? { value: initialValues.country, label: initialValues.country } : null,
    state: initialValues.state ? { value: initialValues.state, label: initialValues.state } : null,
