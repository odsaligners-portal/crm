...
const DistributerQuickLinks = () => {
  const quickLinks = [
    {
      title: "Manage Patients",
      description: "View and manage patient cases",
      icon: <MdPeople className="h-6 w-6" />,
      href: "/distributer/patients",
    ...
    },
    {
      ...
      href: "/distributer/notifications",
    ...
    },
    {
      ...
      href: "/distributer/educational-material",
    ...
    },
    {
      ...
      href: "/distributer/terms-and-conditions",
...
export default DistributerQuickLinks;
