...
export default function UserDropDownDistributer() {
  ...
  useEffect(() => {
    setMounted(true);
    // Fetch only the profilePicture from API (use Redux for other details)
    const fetchProfilePicture = async () => {
      ...
      try {
        ...
        const res = await fetch('/api/distributer/user/profile', {
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          {profilePicture?.url ? (
            ...
            <span className="w-11 h-11 flex items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-blue-300 text-white text-xl font-bold">
